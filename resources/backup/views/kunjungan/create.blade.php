                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample">
                            <input type="hidden" value="{{ Auth::user()->emp_number }}" id="emp_number" name="emp_number">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tanggal_tujuan"
                                    placeholder="Tahun-Bulan-Tanggal" name="tanggal_tujuan" style="color: #ffffff">
                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-check">
                                            <input type="text" class="form-control" id="jam_mulai" name="jam_mulai"
                                                value="00:00" style="color: #ffffff">
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
